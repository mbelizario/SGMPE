...
$('#edit-btn').on('click', function(){
    var prouductId = $('input[name=prouductId]:checked').val();
    var base_url = $('#base_url').val();
    window.location.href = base_url+'products/edit/'+prouductId;
...
$('#rmv-btn').on('click', function(){
    ...
    $.ajax({
        ...
        {
            $.notify("Falha ao enviar os dados! Código do erro: #product003", "error");
        }
    })
