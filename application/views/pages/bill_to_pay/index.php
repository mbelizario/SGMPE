...
<div class="row">
    <div class="col-lg-12">
        <div class="pages-toolbar">
            <ul>
                <li> <a href="<?php echo base_url('billsToPay/add')?>" class="btn btn-info"> <i class="fa fa-plus">Adicionar</i></a> </li>
...
<script src="<?php echo base_url('public/js/pages/bill_to_pay/bill_to_pay.js')?>"></script>
