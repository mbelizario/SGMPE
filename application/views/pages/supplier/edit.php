...
<div class="panel panel-default">
    <div class="panel-heading">Atualizar Fornecedor</div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group" id="form-companyName">
                        ...
                        <input id="companyName" name="companyName"class="form-control"
                               placeholder="Razão Social" value="<?php if($company_name) echo $company_name;?>">
                    </div>
                </div> <!--col-->
                <!-- CNPJ -->
                <div class="col-lg-6 col-md-12">
...
<script src="<?php echo base_url('public/js/pages/supplier/edit.js')?>"></script>
