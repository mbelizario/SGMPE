<div class="row">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('BillsToReceive')?>">Contas a receber</a></li>
        <li class="active">Adicionar conta a receber</li>
    </ol>
</div><!--/.row-->
...
<div class="panel panel-default">
    <div class="panel-heading">Adicionar conta a receber</div>
                    ...
                    <div class="form-group" id="form-customer">
                        ...
                        <select id="customer" name='customer' class="form-control">
                            ...
                            <?php foreach ($customers as $c):?>
                                <option value="<?php echo $c->id?>"> <?php echo $c->person_name?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div><!--col-->
            ...
            <div class='row'>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="form-group" id="form-receivedAmount">
                        ...
                        <input id="receivedAmount" name='receivedAmount' placeholder="Valor recebido"
...
<script src="<?php echo base_url('public/js/pages/bill_to_receive/add.js')?>"></script>
